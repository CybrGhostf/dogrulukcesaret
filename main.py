...
def button():
	BUTTON=[[InlineKeyboardButton(text="👨🏻‍💻 Sahibim ",url="t.me/Sairbey")]]
	BUTTON+=[[InlineKeyboardButton(text="🌱 Kanal 🌱",url="https://t.me/Sairingunlugu")]]
